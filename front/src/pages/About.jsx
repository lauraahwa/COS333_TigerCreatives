    ...
    <Container>
      ...
      <StyledAccordion
        ...
        content={`<p><strong>For Buyers:</strong></p>
          ...
          <p>When starting an auction, sellers provide a 'Price' and 'Auction Start Price'. Only the 'Auction Start Price' is used for the auction. The auction end date must be set at least 24 hours after the current time.</p>
          <p>If no bids have been placed when the auction ends, the listing will be removed. Sellers can re-upload as a new auction or set a fixed price. Editing the auction end date is a feature our team is working on.</p>`
        }
      />
      <StyledAccordion
